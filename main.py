...
speed = speed_x = speed_y = 5                                           # Cкорость ракеток

racket1 = Player(img_racket, 30, 200, speed, 50, 150, 0)                 # Создание левого игрока
racket2 = Player(img_racket, 1120, 200, speed, 50, 150, 0)               # Создание правого игрока
ball = GameSprite(img_asteroid, 200, 200, speed, 50, 50)                 # Создание мяча
